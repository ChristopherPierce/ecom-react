...
const mapDispatchToProps = (dispatch) => {
	return {
		addProductToCart: (product) =>
			dispatch(actions.addProductToCart(product, 1)),
		...
		incProductQuantity: (item) =>
			dispatch(actions.incProductQuantity(item)),
		decProductQuantity: (item) =>
			dispatch(actions.decProductQuantity(item)),
